function main() {
  ...
  const url = `http://gateway.marvel.com/v1/public/characters?limit=1&offset=${randomNumber(
    2,
    50
  )}&ts=${timestamp}&apikey=${public}&hash=${hash}`;
  //request
...
function createHero(heros) {
  heros.forEach((hero) => {
    //if text don't have /image_not_available/g do {};
    //id
